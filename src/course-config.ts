...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A production and criticism course treating AI-generated video — the " +
    "six-fingered ad, the uncanny history explainer, the product demo " +
    "nobody filmed — as a genre with its own aesthetics, economics and " +
    "ethics, taught the way film school teaches melodrama.",
  tags: ["synthetic media", "production", "media studies"],
